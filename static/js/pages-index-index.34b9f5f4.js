(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
	["pages-index-index"], {
		...
		df1a: function(t, e, i) {
			var n = i("24fb");
			e = n(!1), e.push([t.i,
				".register_title[data-v-621e62f9]{width:%?750?%;height:%?100?%;position:fixed;bottom:%?0?%;display:flex;justify-content:center;align-items:center;flex-direction:row}.register_title_text[data-v-621e62f9]{font-family:Arial;font-style:normal;font-weight:400;font-size:%?26?%;line-height:%?30?%;overflow:hidden;text-overflow:ellipsis;color:#08122d}.content[data-v-621e62f9]{display:flex;flex-direction:column;align-items:center;justify-content:center}.logo{height:70px;width:70px;margin-top:%?300?%;margin-left:auto;margin-right:auto;margin-bottom:%?50?%}.text-area[data-v-621e62f9]{display:flex;justify-content:center}.title[data-v-621e62f9]{font-size:%?36?%;color:#08122d;font-weight:700}.text-area2[data-v-621e62f9]{display:flex;justify-content:center;align-items:center;width:%?550?%;height:%?150?%;border-radius:%?75?%;background-color:#08122d;position:fixed;bottom:%?100?%}.title2[data-v-621e62f9]{font-size:%?46?%;color:#fff}",
				""
			]), t.exports = e
		},
		e54a: function(t, e, i) {
